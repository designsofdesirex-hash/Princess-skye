...
(function () {
  ...
  const translations = {
    en: {
      ...
      channels_title: "My Only Official Links",
      channels_desc: "Beware of impersonators and copycats. Below are the ONLY verified official platforms, tribute channels, and wishlists for me.",
      ...
      card_fv_desc: "High-definition photo feeds, daily updates, behind-the-scenes teasers, and ongoing subscription access to my world.",
      card_fv_btn: "Join Fanvue ↗",
      card_rev_badge: "INSTANT CASH SPOILING",
      card_rev_title: "Revolut",
      card_rev_desc: "Instant, frictionless bank-speed tributes. Send cash directly to fund my shopping spree, coffee, or whatever I command.",
      ...
      card_amz_desc: "Hand-picked wardrobe, beauty, designer indulgences, and spoiling items shipped directly and discreetly to me.",
      ...
      card_x_desc: "My primary public kingdom. Daily brat findom thoughts, lifestyle updates, teasers, and spontaneous drain commands.",
      card_x_btn: "Follow on X (@princessskyexxx) ↗",
      card_xb_badge: "OFFICIAL BACKUP ACCOUNT",
      card_xb_title: "X Backup Account",
      card_xb_desc: "My official verified backup account. Follow immediately to guarantee uninterrupted contact, announcements, and updates.",
      card_xb_btn: "Follow Backup (@Skyesbackup_x) ↗",
      vault_eyebrow: "EXCLUSIVES &amp; TEASERS",
      vault_title: "Royal Media Vault",
      vault_desc: "Official preview clips and teasers from me. Complete uncensored video sets and custom requests are available on LoyalFans &amp; Fanvue.",
    ...
    tabBtns.forEach(btn => {
      on(btn, 'click', () => {
        ...
        items.forEach(item => {
          ...
          } else if (filter === 'all' || filter === type) {
            item.style.display = '';
          } else {
            item.style.display = 'none';
          }
